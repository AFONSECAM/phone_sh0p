    ...
    if(!isset($_GET['update'])){
        if(empty($_POST['nombre'])){
            echo "<div class='alert alert-danger'>Diligencie el campo nombre</div>
                    <a href='form_create_brand.php' class='btn btn-info'>Intentar nuevamente</a>";
            return;
            ...
            echo "<div class='alert alert-success'>Se guardó correctamente!</div>
                    <a href='show_brands.php' class='btn btn-info'>Ver las marcas</a>";
        }
    }else{
        $updateBrand = $marca->updateBrand($_POST['id_brand'], $_POST['nombre'], $_POST['tipo']);
        echo $updateBrand;
    }
