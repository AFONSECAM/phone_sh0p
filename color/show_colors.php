        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                                    ...
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            for ($i = 0; $i < sizeof($colores); $i++) {
                                                ...
                                                echo "<th scope='row'>" . $colores[$i]['id_color'] . "</th>";
                                                echo "<td>" . $colores[$i]['color_name'] . "</td>";
                                                echo "<td>                                    
                                    <a href='form_edit_color.php?id_color=" . $colores[$i]['id_color'] . "' class='btn btn-sm btn-warning'><i class='fas fa-pen text-white'></i></a>
                                    <a href='delete_color.php?id_color=" . $colores[$i]['id_color'] . "' class='btn btn-sm btn-danger'><i class='fas fa-trash text-white'></i></a>
                                </td>";
                                                echo "</tr>";
                                            }
                                            ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="form_create_color.php" class="btn btn-primary float-right">Nuevo color</a>
                        </div>
                    </div>
                </div>
            </section>
